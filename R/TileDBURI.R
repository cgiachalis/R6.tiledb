#' @title TileDB URI Parser
#'
#' @description
#' An R6 class to parse and handle tileDB URI paths.
#'
#' @examples
#' uri <- "tiledb://namespace/s3://bucket"
#'
...
TileDBURI <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description Create a new TileDB URI.
    #'
  ...
  active = list(
    ...
    scheme = function(value) {
      ...
      if (!missing(value)) {
        .emit_read_only_error("scheme")
      }

      private$.pieces$scheme
    },
    ...
    tiledb_cloud_uri = function(value) {
      ...
      if (!missing(value)) {
        .emit_read_only_error("tiledb_cloud_uri")
      }

      private$.tiledb_cloud_uri
    },
    ...
    object_uri = function(value) {
      ...
      if (!missing(value)) {
        .emit_read_only_error("object_uri")
      }
