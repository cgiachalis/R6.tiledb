...
#' <li><span class="pkg-link" data-pkg="R6.tiledb" data-topic="TileDBArray" data-id="get_metadata"><a href='../../R6.tiledb/html/TileDBArray.html#method-TileDBArray-get_metadata'><code>$get_metadata()</code></a></span></li>
#' <li><span class="pkg-link" data-pkg="R6.tiledb" data-topic="TileDBArray" data-id="set_metadata"><a href='../../R6.tiledb/html/TileDBArray.html#method-TileDBArray-set_metadata'><code>$set_metadata()</code></a></span></li>
