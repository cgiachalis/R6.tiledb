...
# C:/Users/cgiac/AppData/Local/Temp/Rtmp4kyD4C/file2e9c661b3b74
# ├── __commits
# │   ├── __1784534701510_1784534701510_76243f7438b6f85d79ccdd42df93b7c6_22.wrt
# │   └── __1784534701884_1784534701884_49022ebbbaa9e56f047bc20fdefded3b_22.wrt
# ├── __fragments
# │   ├── __1784534701510_1784534701510_76243f7438b6f85d79ccdd42df93b7c6_22
# │   │   ├── a0.tdb
# │   │   ├── a0_validity.tdb
# │   │   ├── a1.tdb
# │   │   ├── a1_validity.tdb
...
# │   └── __1784534701884_1784534701884_49022ebbbaa9e56f047bc20fdefded3b_22
# │       ├── a0.tdb
# │       ├── a0_validity.tdb
# │       ├── a1.tdb
# │       ├── a1_validity.tdb
...
# ├── __meta
# └── __schema
#     ├── __1784534701436_1784534701436_1b85456fd2a9f9ac73cadc4c4cd34a9b
#     ├── __1784534701804_1784534701804_32c542f45215a36cbfa9e923035a0134
#     └── __enumerations
# 
  ...
  public = list(
    ...
    create = function(schema_name = c("generic_date",
      ...
      sch <- switch(
        schema_name,
        generic_date = {
          R6.tiledb:::.gen_ts1dim_schema(attr = attr_names, type_index = 0, ctx = self$ctx)
        },
        generic_datetime = {
          R6.tiledb:::.gen_ts1dim_schema(attr = attr_names, type_index = 1, ctx = self$ctx)
        },
    ...
    add_symbols = function(syms) {
      ...
      lapply(syms, function(.s) {
        attr <- tiledb::tiledb_attr(
          ...
          ncells = 1,
          nullable = TRUE,
          filter_list = .tiledb_flist(level = -1, name = "ZSTD", ctx = self$ctx),
          ctx = self$ctx)
