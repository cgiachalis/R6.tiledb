...
R6.tiledb also provides classes with additional functionality, S3 methods and convenient utilities that makes a lot easier to interact with TileDB objects.
